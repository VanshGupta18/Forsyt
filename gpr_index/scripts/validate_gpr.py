...
from scripts.paths import CALDARA_DAILY_CANDIDATES, CALDARA_MONTHLY_CANDIDATES, OUTPUT_DIR
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output-dir",   default=str(OUTPUT_DIR), help="Directory containing gpr_*.csv outputs")
