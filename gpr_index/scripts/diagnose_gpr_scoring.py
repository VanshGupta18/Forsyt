...
from scripts.paths import GKG_PROCESSED_DIR, VALIDATION_DIR
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--processed-dir", default=str(GKG_PROCESSED_DIR))
    p.add_argument("--output-dir",    default=str(VALIDATION_DIR))
